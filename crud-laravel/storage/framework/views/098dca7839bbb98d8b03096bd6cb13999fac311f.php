...
<?php $__env->startSection('contenido'); ?>
    ...
    <form action="<?php echo e(route('tarea.store')); ?>" method="POST">
...
<?php $component = $__env->getContainer()->make(App\View\Components\TareaFormBody::class, [] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('tema.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crud-laravel\resources\views/tarea/create.blade.php ENDPATH**/ ?>